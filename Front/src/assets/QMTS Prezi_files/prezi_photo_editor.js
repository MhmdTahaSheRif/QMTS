;(function(){var baseUrl;var __factory=function(){var module=(function(dependencies){return function(init){return init.call({},(function(){return{getSpaghettiVersion:function(){return "14.0-9-g58006c6";},getModuleName:function(){return "prezi_photo_editor";},getModuleVersion:function(){return "release-2023w26-base-4-g4a3c2ed4bcb";},getResourceUrl:function(resource){if(resource.substr(0,1)!="/"){resource="/"+resource;}return baseUrl+resource;},"dependencies":{"prezi_cet_model_editor":dependencies[0],"prezi_featureswitcher":dependencies[1],"prezi_i18n":dependencies[2],"prezi_logger":dependencies[3],"prezi_plugin_api":dependencies[4],"prezi_utils":dependencies[5]}};})());};})(arguments);var moduleImpl=(function(){return module(function(Spaghetti) {
...
module$PhotoEditorPlugin$default.PhotoEditorPlugin = class {
  ...
  init(applicationApi) {
    applicationApi.onDocumentChange(() => {
      ...
      if (selectedImageId != null) {
        this.session.document.read((cb) => {
          ...
          this.uiRoot.setState({isEnabled:image != null && image.imageAsset.url != null && !image.isPlaceholder, selectedImageId:image.locked ? null : image.id});
        });
      }
    });
    applicationApi.onSelectionChange((selectionInfo) => {
      ...
      this.session.document.read((cb) => {
        if (selection.length === 1) {
          ...
          if (transformedObject != null && transformedObject.is(ObjectKind$$module$PhotoEditorPlugin.image) && !transformedObject.locked) {
    ...
    this.uiRoot = applicationApi.declareUI({selectedImageId:null, license:null, isEnabled:true}, (state, ui) => {
      if (state.license && state.license.featureSet.pitchImageIntegration && state.selectedImageId != null) {
        ui.createPropertyBarItem((propertybarUi) => propertybarUi.button({id:"photo-editor-property-bar-button", groupWeight:1, weight:6, icon:module$node_modules$prezi_plugin_api$default.IconSmallId.EditImage, tooltip:module$node_modules$prezi_i18n$default.I18n.ts("Edit image"), enabled:state.isEnabled, onClick:(uat) => {
