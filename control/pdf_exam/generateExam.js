    ...
    messages: [
      {
        role: "user",
        content:
          "i need to generate at least 7 questions from this content and give 4 choices to each question and the correct answer in json format, need format to be like: questions: [{question: '', correct_answer: '', choices:[]}]",
      },
    ],
  };
